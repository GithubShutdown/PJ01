...
urlpatterns = [
    ...
    path('topgroup/<int:topgroup_id>/', TopGroupView.as_view(), name='topgroup'),
    ...
    path('add-user-info/', AddUserInfoView.as_view(), name='add-user-info'), #20230123 to add user info view
    path('add-user-weather-info/', AddUserWeatherInfoView.as_view(), name='add-user-weather-info'), #20230123 to add user info view
    path('add-group-name-info/', AddGroupNameInfoView.as_view(), name='add-group-name-info'),
    path('add-group-user-info/', AddGroupUserInfoView.as_view(), name='add-group-user-info'),
