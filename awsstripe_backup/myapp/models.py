...
class SkypeMyNameModel(models.Model):
    ...
    images = models.ImageField(upload_to='images/', blank=True)#20230111
...
##################openweather_place######################################################################################
class WeatherPlaceModel(models.Model):
    user = models.OneToOneField(User, related_name='weather_place_id', on_delete=models.CASCADE)
    weatherplace = models.CharField(max_length=100)

##################SkypeGroupModel######################################################################################
class GroupNameModel(models.Model):
    group_name = models.CharField(max_length=100)

    def __str__(self):
        return self.group_name

class SkypeGroupModel(models.Model):
    group_name = models.ForeignKey(GroupNameModel, related_name='group_name_id', on_delete=models.CASCADE)
    user = models.ForeignKey(User, related_name='skype_group_user', on_delete=models.CASCADE)
